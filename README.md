[![Build Status](https://dev.azure.com/LJDevOpsDemo/ContosoAirDevOps/_apis/build/status/ljspacemonkeyz.ContosoAir?branchName=master)](https://dev.azure.com/LJDevOpsDemo/ContosoAirDevOps/_build/latest?definitionId=1&branchName=master)
